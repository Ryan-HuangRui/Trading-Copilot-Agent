...
- The muted cron starts the persistent earnings continuation worker. A round freezes its public cutoff and uses bounded soft-quota windows; progressing work may hand off across worker generations instead of treating the cron timeout or one day's role counts as target completion.
