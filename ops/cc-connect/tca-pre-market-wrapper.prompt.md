# Trading-Copilot Pre-Market Skill Trigger

Use repo-only Skill `$tca-pre-market-analysis` to run the scheduled Trading-Copilot-Agent pre-market workflow from repository root.
