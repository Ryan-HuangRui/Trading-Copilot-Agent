...
Daily DAG: company tasks -> affected-industry tasks -> validation. A bounded challenger is added only for a material contradiction or important thesis revision. Quarterly DAG: coverage audit/gap-filling -> industry draft -> independent challenge -> synthesis -> validation. Cross-industry synthesis depends on eligible industry reports, with explicit partial coverage at deadline.
