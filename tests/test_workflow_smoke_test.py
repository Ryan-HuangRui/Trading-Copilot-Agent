...
"""
            ...
            self.assertIn("paper-order-replace", payload["steps"])
            ...
            self.assertEqual(payload["steps"]["paper-order-replace"]["summary"]["replace_candidates"], 0)
            ...
            self.assertTrue((root / "report" / "2026-05-26" / "paper-replace-plan.json").exists())
