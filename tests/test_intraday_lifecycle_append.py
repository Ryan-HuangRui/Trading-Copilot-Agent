...
class IntradayLifecycleAppendTest(unittest.TestCase):
    ...
    def seed_artifacts(self, root: Path) -> None:
        ...
        write_json(report / "paper-replace-plan.json", {"dry_run": False, "summary": {"replace_candidates": 1, "replaced": 1, "errors": 0}})
    ...
    def test_appends_lifecycle_section_and_summary_artifact(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("改单：candidates=1；replaced=1；errors=0", text)
